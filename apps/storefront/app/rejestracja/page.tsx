    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-cream-muted text-sm">Dołącz do nas i śledź swoje zamówienia</p>
        </div>
        ...
        <div className="bg-ink-800 border border-ink-600 rounded-2xl p-8 space-y-5">
          ...
          <p className="text-center text-sm text-cream-muted">
            Masz już konto?{' '}
            <Link href="/logowanie" className="text-gold font-medium underline hover:no-underline">
              Zaloguj się
            </Link>
          </p>
        </div>
